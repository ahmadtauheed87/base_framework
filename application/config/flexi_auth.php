...
*/
	...
	*/
	$config['security']['recaptcha_public_key']	= '6LdTPigTAAAAADFWE-txwIaRTpVPCXRmtwGvoE4r';
	$config['security']['recaptcha_private_key'] = '6LdTPigTAAAAAIlA5dHLvwH4SQ8_6YuJlg3KON_9'; 
	...
	*/
	...
	$config['email']['site_title'] = "Bafna CRM";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "anands017@gmail.com";
